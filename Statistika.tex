...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-003.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-011.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-012.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-015.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/Statistika-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-027.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-032.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-033.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-034.png}
\begin{eulercomment}
Menghapus data.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-037.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-038.png}
\begin{eulercomment}
...
\end{eulercomment}
\eulersubheading{Soal 3 (Median data kelompok)}
\begin{eulercomment}
...
\end{eulercomment}
\eulersubheading{Soal 5 (Distribusi frekuensi)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/Statistika-039.png}
\end{eulernotebook}
\end{document}
